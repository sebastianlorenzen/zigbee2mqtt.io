...
An alternative method to reset the device: 
1. Start with the light turned off
2. Switch the light 3 times on and off and it will reset and start pairing mode. (Slowly blinking)
3. You might need to switch it off and on again afterwards if pairing does not start automatically.
